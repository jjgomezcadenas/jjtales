...
Pero no había vuelto a leer la Odisea de un tirón hasta ahora. Y lo he hecho, porque Juanma Tobal ha conseguido quitarme la espina que don Luis me dejó clavada hace medio siglo. Veamos por qué. Su versión empieza así:
...
El famoso \gr{πολύτροπον} tiene miga. \emph{Poly} $\to$ mucho(s); \emph{tropon} $\to$ raíz \emph{tropos}, con dos sentidos: por una parte hacer girar, volver, dar vueltas (de ahí \emph{milerrante} en Tobal) y por otra modo, manera, recurso… $\to$ el de muchos recursos, o sea sagaz, astuto, de ahí Segalá (de multiforme ingenio) y, como veremos en un instante, Pabón (hábil). Y ya puestos, Wilson escoge «complicated», que como ella misma explica usa la raíz latina \emph{complicare}, casi literalmente, «de muchos pliegues», o «muchas vueltas». Valga esta sola y maravillosa palabra para ilustrar los desafíos y el encanto de la traducción. Donde Homero dice \emph{politropos}, aprovechándose de la duplicidad del griego clásico, el traductor tiene que escoger qué sentido primar. 

Pero el caso es que Tobal escribe: «De ese hombre, Musa, háblame, milerrante», fiel a Homero (que empieza con «andra», el hombre, en acusativo) y se inventa tan campante un precioso neologismo «milerrante» para calcar un aspecto de «politropos». 
...
Y aquí la del camorrista de Tobal: 
...
Espero, amiga lectora, compañero lector, haberte dejado con la miel en la boca. En la tercera parte, seguiremos leyendo juntos esta magnífica \emph{Odisea} y hablaremos de la rima, de los neologismos y de otros seres mitológicos.
